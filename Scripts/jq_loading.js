(function ($) {
    ...
    MyJqMyConfirm.prototype = {
        init: function (options){
            ...
            width = width * 0.8;
            var defaults = {width: width+"px", cancelButton: true, confirmButton: true, title: "閹绘劗銇�",
                cancel_btn_title: "閸欐牗绉�", confirm_btn_title: "绾喛顓�",
    ...
    MyJqMyLoad.prototype = {
        init: function (options){
            ...
            var width = $(document).width();
            width = width * 0.5;
            var defaults = {width: width+"px", title: "鏁版嵁鍔犺浇涓�..."};
            if(typeof options === 'undefined') options = {};
            this.settings = $.extend( {}, defaults, options );
